...
@NonNullApi
public class KotlinProjectProjectDependency extends DelegatingProjectDependency {

    @Inject
    public KotlinProjectProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
